...
urlpatterns = [
    ...
    path('administrador/homeAdmin/progreso/', progreso_home_admin, name='progresoHomeAdmin'),
    ...
    path("administrador/ordenes/<int:orden_pk>/pedidos/<int:pk>/lotes/resumen/", resumen_lotes_pedido, name="resumenLotesPedido"),
